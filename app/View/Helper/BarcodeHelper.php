...
class BarcodeHelper extends AppHelper{
    ...
    public function getImg($code,$type='C128',$size=[30,200]){
        // sample data to encode
        $data_to_encode = $code;//'1012012,BLAHBLAH01234,1234567891011';
        // Generate Barcode data
        $this->barcode();
        $this->setType($type);
        $this->setCode($data_to_encode);
